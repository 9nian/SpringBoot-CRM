...
import com.gb.crm.commons.utils.HSSFUtils;
...
public class ActivityController {
    ...
    @RequestMapping("/exportActivitysById.do")
    public void exportActivitysById(HttpServletResponse response,String [] id) throws Exception{
        //调用service层方法，查询所有的市场活动
