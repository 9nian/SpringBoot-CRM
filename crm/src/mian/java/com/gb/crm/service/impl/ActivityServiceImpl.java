...
import com.gb.crm.workbench.mapper.ActivityMapper;
...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public List<Activity> queryActivitysById(String[] id) {
    ...
    @Override
    public List<Activity> queryActivityForConvertByNameContactsId(Map<String, Object> map) {
